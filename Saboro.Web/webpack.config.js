...
module.exports = {
    ...
    entry: {
        izitoast: {
            import: ["izitoast/dist/js/iziToast.min.js", "izitoastcss"],
            runtime: "runtime",
        },
        uikit: {
            import: ["uikit", "uikitcss", "uikiticonsjs"],
            runtime: "runtime",
        },
        jquery: {
    ...
    resolve: {
        ...
        alias: {
            ...
            izitoastcss: path.resolve(
                __dirname,
                "node_modules/izitoast/dist/css/iziToast.min.css"
            ),
            jquery: "jquery/dist/jquery.min.js",
            uikit: "uikit/dist/js/uikit.min.js",
            uikiticonsjs: path.resolve(
                __dirname,
                "node_modules/uikit/dist/js/uikit-icons.min.js"
            ),
            uikitcss: path.resolve(
                __dirname,
