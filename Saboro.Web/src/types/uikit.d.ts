...
https://www.npmjs.com/package/@types/uikit
https://github.com/DefinitelyTyped/DefinitelyTyped/blob/master/types/uikit/dist/js/uikit.d.ts

Obs: os tipos não estão sendo atualizados pelos donos do projeto, então vamos manter uma cópia local e atualizar manualmente.
